#pragma once
#ifndef __NetClient_CLASS__
#define __NetClient_CLASS__
...
public:
	...
	// Server Start
	bool Start(const wchar_t* IP, unsigned short PORT, int createWorkerThreadCnt, int runningWorkerThreadCnt, bool nagelOff, unsigned char packet_code, unsigned char packet_key);
