...
const __int64 MAX = 1000;
const int MAXBITS = 17;
const int MAX_COUNT_VALUE = 47;
const __int64 PTRMASK = 0x00007FFFFFFFFFFF;
const __int64 MAXIMUMADDR = 0x00007FFFFFFEFFFF;
...
private:
	...
	alignas(64) uint64_t m_uniqueVal;								// 포인터 마스킹을 위한 unique value
...
ObjectLockFreeStackFreeList<DATA>::ObjectLockFreeStackFreeList(int iBlockNum, bool bPlacementNew)
	: _pFreeBlockNode(nullptr), m_bPlacementNew(bPlacementNew), m_iCapacity(iBlockNum), m_iUseCount(0), m_uniqueVal(0)
{
